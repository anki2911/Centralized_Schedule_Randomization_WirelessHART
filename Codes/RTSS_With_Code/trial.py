...
plt.yticks(np.arange(0, 10000, 1000),fontsize='large', fontweight='bold') 
plt.title('Graph C',fontsize='large', fontweight='bold')
plt.ylabel('upper-approximated schedule entropy',fontsize='large', fontweight='bold',labelpad=20)
